...
plot dat_f using 1:($3+$6+$9) title 'Power Use (phase 0+1+2, Watts)' with lines linecolor rgb "#ffff00"

set ylabel "(V)"
set y2label "(V)"

set output '/home/ghz/power_wx/plots/power.batt.png
plot dat_f using 1:12 title 'Battery Voltage (Volts)' with lines linecolor rgb "#ff00ff"
